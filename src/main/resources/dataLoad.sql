...
('CORE_SEG_GRLES','Core de Seguros Generales', 2, 'Luz Elvira Vásquez Monsalve', 'levasquez@sura.com.co'),
('AUTOM_PROC','Automatización de Procesos', 6, 'Mildred María Marín Ramírez', 'mmarinr@sura.com.co'),
('ASISTENCIA','Asistencia', 2 , 'Carlos Alberto Carmona Flórez', 'cacarmona@sura.com.co'),
('EVALUACION','Evaluación de Riesgos',6, 'Carlos Alberto Carmona Flórez', 'cacarmona@sura.com.co')
;

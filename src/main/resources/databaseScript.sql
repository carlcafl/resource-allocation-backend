...
create table tblDepartments(id serial NOT NULL primary key, departmentType typDepartmentType NOT NULL, name varchar(30) NOT NULL, active BOOLEAN DEFAULT TRUE);
